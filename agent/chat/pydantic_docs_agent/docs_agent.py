...
import logfire
from .data import get_docs_dir, get_markdown, get_table_of_contents
from .db import open_populated_table
...
docs_agent.tool_plain(get_table_of_contents)
