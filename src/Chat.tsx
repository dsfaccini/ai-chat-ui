...
const Chat = () => {
    ...
    useEffect(() => {
        const base = (window as any).__AI_CHAT_UI_API_BASE__ || ''
        setApiBase(base)
    }, [])
    ...
    useEffect(() => {
        ...
        const checkHealth = async () => {
            ...
            backoffIntervalRef.current = Math.min(backoffIntervalRef.current * 2, 60000)
                        ...
                        <PromptInputTools>
                            ...
                            {configQuery.data && model && (
                                ...
                                >
                                    ...
                                    <PromptInputModelSelectContent>
                                        {(configQuery.data as { models: { id: string; name: string }[] }).models.map(
                                            (model) => (
